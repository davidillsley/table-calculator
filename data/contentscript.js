self.port.on("numbersDetails", function(myAddonEventPayload) {
  ...
  document.getElementById("listCopy").addEventListener("click", function(){self.port.emit("setClipboard",{"value":numbersString})});
  document.getElementById("sumCopy").addEventListener("click", function(){self.port.emit("setClipboard",{"value":myAddonEventPayload.total})});
  document.getElementById("meanCopy").addEventListener("click", function(){self.port.emit("setClipboard",{"value":myAddonEventPayload.mean})});
  document.getElementById("medianCopy").addEventListener("click", function(){self.port.emit("setClipboard",{"value":myAddonEventPayload.median})});
});
